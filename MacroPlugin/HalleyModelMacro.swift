...
private extension HalleyModelMacro {
    ...
    static func extractCustomLinkKey<Context: MacroExpansionContext>(
        ...
        let linkAttribute = variable
            ...
            .first {
                $0.attributeName.as(IdentifierTypeSyntax.self)?.name.text == "HalleyLink"
            }
...
extension HalleyModelMacro: ExtensionMacro {
    public static func expansion(
        ...
        let halleyCodableExtension = try ExtensionDeclSyntax("extension \(type.trimmed): HalleyCodable {}")

        return [halleyCodableExtension]
    }
}
